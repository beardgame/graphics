...
{
    /// <summary>
    /// Json.NET converter for <see cref="UVRectangleContainer"/>
    /// </summary>
    class UVRectangleContainerConverter : JsonConverterBase<UVRectangleContainer>
    {
        /// <summary>
        ...
        protected override UVRectangleContainer readJsonImpl(JsonReader reader, JsonSerializer serializer)
        {
            ...
            return new UVRectangleContainer(uv, absolute);
        }
        ...
        protected override void writeJsonImpl(JsonWriter writer, UVRectangleContainer value, JsonSerializer serializer)
        {
